...
import chat_client_2 as gRPC_client
from chat_client_2 import ChatData
import grpc
...
class ChatGUI(tk.Tk):
    ...
    def stubHandler(self, ):
        ...
        # TODO : future -> event base gRPC implement ㅇㅅㅇ?
        while True:
            ...
            if(self.msgCount_received > self.msgCount or mcount > self.msgCount):
                ...
                msgs: Iterable[ChatData] = self.grpcClient.GetMessage(
                    self.msgCount)
