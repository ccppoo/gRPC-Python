...
class ChatServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMessage = channel.unary_stream(
                ...
                response_deserializer=message__pb2.Chat.FromString,
                )
...
class ChatServerServicer(object):
    ...
    def GetMessage(self, request, context):
        """Server returns messages as stream
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ChatServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMessage': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=message__pb2.Chat.SerializeToString,
            ),
...
class ChatServer(object):
    ...
    def GetMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/chating.server.ChatServer/GetMessage',
            chat__server__pb2.Ok.SerializeToString,
            message__pb2.Chat.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
